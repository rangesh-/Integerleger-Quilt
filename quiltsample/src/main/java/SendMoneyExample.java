...
public class SendMoneyExample {
    ...
    private static final String SENDER_ACCOUNT_USERNAME = "user_pr5hifye";
    // NOTE - replace this with the passkey for your sender account
    private static final String SENDER_PASS_KEY = "lufkmvt5i87df";
    // NOTE - replace this with the payment pointer for your receiver account
    private static final String RECEIVER_PAYMENT_POINTER = "$rs3.xpring.dev/accounts/user_iu823q94/spsp\n";
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        InterledgerRustNodeClient rustClientreceiver =
                new InterledgerRustNodeClient(newHttpClient(), "user_iu823q94" + ":" + "19q5vterz94pk", TESTNET_URI);
        ...
        SendMoneyResult result = simpleStreamSender.sendMoney(
                SendMoneyRequest.builder()
                       ...
                       .paymentTracker(new FixedSenderAmountPaymentTracker(UnsignedLong.valueOf(100)))
        ...
        System.out.println("Ending balance for Receiver: " + rustClientreceiver.getBalance("user_iu823q94"));
    }
